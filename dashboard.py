...
def create_sum_order_items_df(df):
    sum_order_items_df = df.groupby(by='product_category_name').order_item_id.sum().sort_values(ascending=False).reset_index()
...
st.caption('Copyright (c) Rizki Nardianto 2023', loc='cneter')